...
directorio='C:\Users\Usuario\Desktop\Experimento PABLO\EyeLink_pruebas\imagenes_jpg_definitivo\';
cd(directorio)

path_images=genpath('C:\Users\Usuario\Desktop\Experimento PABLO\EyeLink_pruebas\imagenes_jpg_definitivo\');
addpath(path_images)
...
load(['C:\Users\Usuario\Desktop\Experimento PABLO\EyeLink_pruebas\listas\' subj '_' sname '_lista']);
...
directorio_fondos = 'C:\Users\Usuario\Desktop\Experimento PABLO\EyeLink_pruebas\fondos\';
...
save (['C:\Users\Usuario\Desktop\Experimento PABLO\EyeLink_pruebas\respuestas\' subj '_' sname '_archivos_probe'], 'trigger','imagen', 'fondo_asignado');
sca;
close all;
...
directorio_fondos = 'C:\Users\Usuario\Desktop\Experimento PABLO\EyeLink_pruebas\fondos\';
path_fondos=genpath('C:\Users\Usuario\Desktop\Experimento PABLO\EyeLink_pruebas\fondos\');
addpath(path_fondos)
...
try
    ...
    load(['C:\Users\Usuario\Desktop\Experimento PABLO\EyeLink_pruebas\respuestas\' subj '_' sname '_archivos_probe']);
    results_file=['C:\Users\Usuario\Desktop\Experimento PABLO\EyeLink_pruebas\respuestas\' subj '_' sname '_' run '_results_probe'];
    ...
    instrucciones_imagen = imread('C:\Users\Usuario\Desktop\Experimento PABLO\EyeLink_pruebas\instrucciones_imagenes\recuperacion_tarea.jpg');
    ...
    for i=str2num(trial):length(probe)
        ...
        %             descanso_mitad=imread('C:\Users\Usuario\Desktop\Experimento PABLO\EyeLink_pruebas\instrucciones_imagenes\recuperacion_descanso.jpg');
    ...
    despedida_imagen=imread('C:\Users\Usuario\Desktop\Experimento PABLO\EyeLink_pruebas\instrucciones_imagenes\despedida_imagen.jpg');
