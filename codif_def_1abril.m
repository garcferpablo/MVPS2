...
directoriof='C:\Users\Usuario\Desktop\Experimento PABLO\EyeLink_pruebas\fondos\';
cd(directoriof) 

path_images=genpath('C:\Users\Usuario\Desktop\Experimento PABLO\EyeLink_pruebas\fondos\'); 
addpath(path_images)
...
try
    ...
    % en un archivo
    save(['C:\Users\Usuario\Desktop\Experimento PABLO\EyeLink_pruebas\listas\' subj '_' sname '_lista'], 'lista_def','lista_def_orden','probe');
    
    % se define el nombre del archivo donde se guardaran los resultados de
    % la codificacion
    results_file=['C:\Users\Usuario\Desktop\Experimento PABLO\EyeLink_pruebas\listas\' subj '_' sname '_cod_res'];
    ...
    Instrucciones_imagen=imread('C:\Users\Usuario\Desktop\Experimento PABLO\EyeLink_pruebas\instrucciones_imagenes\codificacion_tarea.jpg');
    ...
    for i= str2num(trial):length(lista_def)  % lista_def tiene combinación de imágenes y fondos que vamos a presentar 180 ensayos
        ...
        %          if i==240 ||i==720
        %              descanso_imagen=imread('C:\Users\Usuario\Desktop\Experimento PABLO\EyeLink_pruebas\instrucciones_imagenes\codificacion_descanso.jpg');
        ...
        %              descanso_mitad=imread('C:\Users\Usuario\Desktop\Experimento PABLO\EyeLink_pruebas\instrucciones_imagenes\descanso_mitad.jpg');
        %              [s1, s2, s3] = size(descanso_imagen);
