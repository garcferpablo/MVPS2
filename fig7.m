function [figure2, table2, sigComparisons2] = fig7(S)
% Igual que fig 6 pero para fijaciones en el fondo
%
% Entradas:
...
%       Subject, RespTag, MeanRec, meanCod1, meanCod2, meanCod3
    ...
    for i = 1:nT
        ...
        if S(i).condTag ~= 30
            ...
            E = C(mask);
            if numel(E) >= 3
                CodFix(i,1:3) = [E(1).fondoFix, E(2).fondoFix, E(3).fondoFix];
            else
                CodFix(i,:) = NaN;
